declare const proto: {
    ...
    fadeInP(this: HTMLElement, ...args: any[]): Promise<HTMLElement>;
    fadeOutP(this: HTMLElement, ...args: any[]): Promise<HTMLElement>;
    fade: boolean;
...
declare function convert(opts: Record<string, string>, args: any[]): Record<string, any>;
